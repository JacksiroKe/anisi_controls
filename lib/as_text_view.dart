...
class AsTextView extends StatefulWidget {
  ...
  static Widget setUp(String setText, double setSize, bool setWeight,
      Color setColor, Color setBackgroundColor) {
  ...
  void modify(String newText, double newSize, bool newWeight, Color newColor,
      Color newBackgroundColor) {
    widgetState!.modifyWidget(
        newText, newSize, newWeight, newColor, newBackgroundColor);
  }
}
...
class AsTextViewState extends State<AsTextView> {
  ...
  void modifyWidget(String setText, double setSize, bool setWeight,
      Color setColor, Color setBackgroundColor) {
    setState(() {
      text = setText;
      fsize = setSize;

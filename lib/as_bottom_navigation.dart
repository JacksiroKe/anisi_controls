...
/// Enhanced Fancy Bottom Navigation Widget
class AsBottomNavigation extends StatefulWidget {
  AsBottomNavigation(
      {@required this.tabs,
  ...
  @override
  AsBottomNavigationState createState() => AsBottomNavigationState();
}

class AsBottomNavigationState extends State<AsBottomNavigation>
